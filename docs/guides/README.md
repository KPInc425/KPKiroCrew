...
| [cheat-sheet.md](cheat-sheet.md) | This machine's quick reference: starting the gateway, switching the Ollama model, using the Runware MCP + skills, and the provider setup. |
